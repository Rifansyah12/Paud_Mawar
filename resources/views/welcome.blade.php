...
@section('content')
    ...
    <section class="ftco-services ftco-no-pb">
      <div class="container-wrap">
        <div class="row no-gutters">
          ...
          <div
            class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-fifth"
          >
            <div class="media block-6 d-block text-center">
              <div
                class="icon d-flex justify-content-center align-items-center"
          ...
          <div
            class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-quarternary"
          >
            <div class="media block-6 d-block text-center">
              <div
                class="icon d-flex justify-content-center align-items-center"
        ...
        <div class="row">
          ...
          >
            <div class="text px-4 ftco-animate">
              <h2 class="mb-4">Profil Pos Paud Mawar 13</h2>
              <p>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Guru</span>Tendik</h2>
            <p>
    ...
    <section class="ftco-section">
      <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Ekstra</span> Kulikuler</h2>
            <p>
              Kegiatan ekstrakurikuler di PAUD Mawar dirancang untuk
              mengembangkan potensi anak secara menyeluruh — tidak hanya dari
              sisi akademik, tetapi juga keterampilan, kreativitas, dan
              karakter. “Setiap anak punya keistimewaan. Tugas kita adalah
              menemukannya dan membantunya tumbuh.” Melalui aktivitas seni,
              olahraga, dan keterampilan, anak-anak belajar percaya diri,
              bekerja sama, dan menemukan hal-hal yang mereka sukai sejak dini.
            </p>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="pricing-entry bg-light pb-4 text-center">
              ...
              <p class="button text-center">
                <a href="#" class="btn btn-quarternary px-4 py-3"
                  >Take A Course</a
                >
              </p>
            </div>
